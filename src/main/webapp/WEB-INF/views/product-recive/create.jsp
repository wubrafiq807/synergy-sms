<div class="content-wrapper" style="margin: 0px;">
	...
	<section class="content-header">
		<h1>Add Receive Product</h1>
		<ul class="top-links">
			<li><a class="btn btn-primary btn-xs"
				href="${pageContext.request.contextPath}/listReciveProduct"> <i
					class="fa fa-reorder"></i>Receive Product List</a>
			</li>
			...
			<div class="col-xs-12">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title center">Receive Product Form</h3>
					</div>
					<!-- /.box-header -->
					<!-- form start -->
					<form action="${pageContext.request.contextPath}/saveReceiveProduct" name="form"
