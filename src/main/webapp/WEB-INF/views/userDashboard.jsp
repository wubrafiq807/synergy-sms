	...
	<section class="content">
		<div class="row">
			<div class="col-xs-12">
				...
				<div id="tabs">
					<ul>
						<li><a href="#tabs-my-jobs">My Requisitions</a></li>
						<li><a href="#tabs-subordinate-jobs">
							<c:if test="${!empty subordinateReqList}"><span class="red">Subordinate Requisitions</span></c:if>
							<c:if test="${empty subordinateReqList}"><span class="green">Subordinate Requisitions</span></c:if>
							<li><a href="#tabs-approved-jobs">Approved Requistions by Me</a></li>
						...
						<div class="box box-primary">
							<div class="box-body table-responsive no-padding">
								...
								<table class="table table-striped display" id="table_id_1">
									...
									<tbody>
										<c:forEach items="${myreqList}" var="myReq" varStatus="tr">
						...
						<div class="box box-primary">
							<div class="box-body table-responsive no-padding">
								...
								<table class="table table-striped display" id="table_id_2">
									...
									<tbody>
										<c:forEach items="${subordinateReqList}" var="myReq" varStatus="tr">
											<tr class="row_no_${tr.count}">
												<td class="text-center" title="Show Job Advance"><a
													href="${pageContext.request.contextPath}/showReq/${myReq.id}">${tr.count}</a>
												</td>
