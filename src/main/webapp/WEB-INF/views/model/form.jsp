...
<div class="form-group">
	...
	<div class="col-sm-6">
		<textarea class="form-control" id="remarks" name="remarks">${model.remarks}</textarea>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-6">
		<select name="status" class="form-control">
			...
			<option value="1" ${model.status eq '1'?'selected':''}>Active</option>
			<option value="0" ${model.status eq '0'?'selected':''}>Inactive</option>
		</select>
	</div>
</div>
		...
		$
				.ajax({
					...
					success : function(data) {
						if (data) {
							document.getElementById('res').innerHTML = "Model already Exist";
